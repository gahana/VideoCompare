...
public class MS_SSIM_Index {

	private ImagePlus image_1_imp, image_2_imp;  //THIS PLUGIN WORKS WITH TWO (AND ONLY TWO) IMAGES OPEN IN IMAGEJ
	private ImageProcessor image_1_p, image_2_p;

	public MS_SSIM_Index(ImagePlus i1, ImagePlus i2) {
		image_1_imp = i1;
		image_2_imp = i2;
	}
